...
const ProjectTop = () => {
  ...
  return (
    <div className="relative bg-[#1F22BF] pb-20">
      {/* Top Content */}
      <div
        className="text-center text-white py-8 sm:py-12 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto"
        data-aos="fade-down"
      >
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 leading-tight sm:leading-snug md:leading-tight">
         Showcasing Excellence in Different Domain
        </h1>
        <div className="text-white/80 text-sm sm:text-base">
          <Link to="/">Home</Link> <span className="mx-2">/</span> Pages{' '}
      ...
      <div className="absolute bottom-0 w-full overflow-hidden leading-[0] pointer-events-none">
        <svg
          className="relative block w-full h-[100px] sm:h-[130px] md:h-[150px]"
