  ...
  return (
    <div className="w-full">
      ...
      <div className="relative bg-[#1F22BF] pb-20">
        <div className="text-center text-white py-10 sm:py-12 md:py-16 px-6 sm:px-10 lg:px-20" data-aos="fade-down">
          ...
          {images.map((img, index) => (
            ...
            >
              <img
                src={img}
                alt={`Gallery ${index + 1}`}
                className="w-full h-96 object-fill hover:scale-105 transition-transform duration-300"
              />
            </div>
          ))}
        </div>
